/**
 * CINEVERSE — UI Icons
 * Tập trung tất cả icon SVG dùng trong toàn bộ project.
 * Import: import { BookmarkIcon, LoginIcon, ... } from "../../ui/icon";
 */
...
export const LoginIcon = ({ size = 13 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const EyeOpenIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ChevronDown = ({ open, size = 10 }) => (
  <svg
